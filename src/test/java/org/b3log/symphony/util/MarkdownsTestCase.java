...
public class MarkdownsTestCase {
    ...
    public void space() {
        if (Markdowns.MARKDOWN_HTTP_AVAILABLE) {
            ...
            Assert.assertEquals(html, "<p>Sym 是一个用 Java 写的实时论坛，欢迎来<a href=\"http://localhost:80/forward?goto=https%3A%2F%2Fhacpai.com\" target=\"_blank\" rel=\"nofollow\">体验 Sym</a>！</p>");
        }
    }
