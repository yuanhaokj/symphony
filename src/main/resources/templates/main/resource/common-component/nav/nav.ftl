<script type="text/x-template" id="nav-common">
                ...
                <nav class="navbar navbar-default yamm">
                    <div class="navbar-header">
                        ...
                        <div class="logo-normal">
                            <a class="navbar-brand" href=""><img src="/templates/main/resource/common-component/public/images/logo.png"
                                                                 alt=""></a>
                        </div>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown yamm-fw yamm-half">
                                <a href="" data-toggle="dropdown"
                                   class="dropdown-toggle active">Mega Menu <b
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="menu-widget text-center">
                                                        <div class="image-wrap entry">
                                                            <img src="/templates/main/resource/common-component/public/upload/course_01.jpg"
