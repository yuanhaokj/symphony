...
<head>
    ...
    <meta name="keywords" content="Alumni Book">
    <meta name="description" content="Alumni Book With Old Schoolmates">
    <meta name="author" content="YuanHaoKJ.CN">

    <#include "../../resource/common/common.ftl" parse=true/>

    <!-- Site Icons -->
    <link rel="shortcut icon" href="/templates/main/workshop/alumni/images/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" href="/templates/main/workshop/alumni/images/apple-touch-icon.png">
    ...
    <link rel="stylesheet" href="/templates/main/workshop/alumni/css/bootstrap.min.css">
    <link rel="stylesheet" href="/templates/main/workshop/alumni/css/font-awesome.min.css">
    <link rel="stylesheet" href="/templates/main/workshop/alumni/css/carousel.css">
    <link rel="stylesheet" href="/templates/main/workshop/alumni/css/animate.css">

    <!--[if lt IE 9]>
    <script src="/templates/main/workshop/alumni/js/vendor/html5shiv.min.js"></script>
    <script src="/templates/main/workshop/alumni/js/vendor/respond.min.js"></script>
    <![endif]-->

    <!-- Custom & Default Styles -->
    <link rel="stylesheet" href="/templates/main/workshop/alumni/style.css">

</head>
<body>
<div id="main">
    <!-- LOADER -->
    <div id="preloader" v-if="false">
        <img class="preloader" src="/templates/main/workshop/alumni/images/loader.gif" alt="">
    </div>
    <!-- END LOADER -->
                ...
                <nav class="navbar navbar-default yamm">
                    <div class="navbar-header">
                        ...
                        <div class="logo-normal">
                            <a class="navbar-brand" href="index.html"><img src="/templates/main/workshop/alumni/images/logo.png" alt=""></a>
                        </div>
                    </div>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="menu-widget text-center">
                                                        <div class="image-wrap entry">
                                                            <img src="/templates/main/workshop/alumni/upload/course_01.jpg" alt="" class="img-responsive">
                                                            <div class="magnifier">
        ...
        <section id="home" class="video-section js-height-full">
            ...
            <div class="home-text-wrapper relative container">
                <div class="home-message">
                    <p>Stay In Contact with Old Friend And Old Schoolmates By AlumniBook</p>
                    <small>AlumniBook is the ideal choice for your friends, your schoolmates and your teachers . Create your online account now with AlumniBook to stay in contact with them. </small>
                    <div class="btn-wrapper">
                        <div class="text-center">
                            <a href="/signUp" class="btn btn-primary wow slideInLeft">Sign Up</a> &nbsp;&nbsp;&nbsp;<a href="#" class="btn btn-default wow slideInRight">Sign In</a>
                        </div>
                    </div><!-- end row -->
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 hidden-sm hidden-xs">
                        <div class="custom-module">
                            <img src="/templates/main/workshop/alumni/upload/device_01.png" alt="" class="img-responsive wow slideInLeft">
                        </div><!-- end module -->
                    </div><!-- end col -->
                    <div class="col-md-8">
            ...
            <div class="container">
                ...
                <div id="owl-01" class="owl-carousel owl-theme owl-theme-01">
                    ...
                    <div class="caro-item">
                        <div class="course-box">
                            <div class="image-wrap entry">
                                <img src="/templates/main/workshop/alumni/upload/course_02.jpg" alt="" class="img-responsive">
                                <div class="magnifier">
                                     <a href="#" title=""><i class="flaticon-add"></i></a>
                                </div>
                            </div><!-- end image-wrap -->
                    ...
                    <div class="caro-item">
                        <div class="course-box">
                            <div class="image-wrap entry">
                                <img src="/templates/main/workshop/alumni/upload/course_03.jpg" alt="" class="img-responsive">
                                <div class="magnifier">
                                     <a href="#" title=""><i class="flaticon-add"></i></a>
                                </div>
                            </div><!-- end image-wrap -->
                    ...
                    <div class="caro-item">
                        <div class="course-box">
                            <div class="image-wrap entry">
                                <img src="/templates/main/workshop/alumni/upload/course_04.jpg" alt="" class="img-responsive">
                                <div class="magnifier">
                                     <a href="#" title=""><i class="flaticon-add"></i></a>
                                </div>
                            </div><!-- end image-wrap -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="box testimonial">
                            <p class="testiname"><strong><img src="/templates/main/workshop/alumni/upload/testimonial_01.png" alt="" class="img-circle"> Jenny LUXURY</strong></p>
                    ...
                    <div class="col-md-4">
                        <div class="box testimonial">
                            <p class="testiname"><strong><img src="/templates/main/workshop/alumni/upload/testimonial_02.png" alt="" class="img-circle"> Martin LEO</strong></p>
                            <p>Quisque porttitor eros quis leo pulvinar, at hendrerit sapien iaculis. Donec consectetur accumsan arcu, sit amet fringilla ex ultricies.</p>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                    ...
                    <div class="col-md-4">
                        <div class="box testimonial">
                            <p class="testiname"><strong><img src="/templates/main/workshop/alumni/upload/testimonial_03.png" alt="" class="img-circle"> John DOE</strong></p>
                            <p>Quisque porttitor eros quis leo pulvinar, at hendrerit sapien iaculis. Donec consectetur accumsan arcu, sit amet fringilla ex ultricies.</p>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="blog-box">
                            <div class="image-wrap entry">
                                <img src="/templates/main/workshop/alumni/upload/blog_01.jpeg" alt="" class="img-responsive">
                                <div class="magnifier">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="blog-box">
                            <div class="image-wrap entry">
                                <img src="/templates/main/workshop/alumni/upload/blog_02.jpeg" alt="" class="img-responsive">
                                <div class="magnifier">
                                     <a href="blog-single.html" title=""><i class="flaticon-add"></i></a>
                                </div>
                            </div><!-- end image-wrap -->
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="blog-box">
                            <div class="image-wrap entry">
                                <img src="/templates/main/workshop/alumni/upload/blog_03.jpeg" alt="" class="img-responsive">
                                <div class="magnifier">
                                     <a href="blog-single.html" title=""><i class="flaticon-add"></i></a>
                                </div>
                            </div><!-- end image-wrap -->
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="widget clearfix">
                            ...
                            <div class="newsletter-widget">
                                ...
                                <img src="/templates/main/workshop/alumni/images/payments.png" alt="" class="img-responsive">
                            </div><!-- end newsletter -->
                        </div><!-- end widget -->
                    </div><!-- end col -->
        ...
        <div class="copyrights">
            <div class="container">
                <div class="clearfix">
                    <div class="pull-left">
                        <div class="cop-logo">
                            <a href="#"><img src="/templates/main/workshop/alumni/images/logo.png" alt=""></a>
                        </div>
                    </div>
                    ...
                    <div class="pull-right">
                        <div class="footer-links">
                            <ul class="list-inline">
                                <li>备案信息:蜀ICP备18007955号 <a href="http://www.beian.miit.gov.cn">工信部备案管理局</a></li>
                                <li>Design : <a href="#">YUANHAOKJ.CN</a></li>
                                <li>Distributed by : <a href="https://www.yuanhaokj.cn/" target="_blank" title="YUANHAOKJ.CN">YUANHAOKJ</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <!-- jQuery Files -->
    <script src="${mvcPath}/main/workshop/alumni/js/jquery.min.js"></script>
    <script src="${mvcPath}/main/workshop/alumni/js/bootstrap.min.js"></script>
    <script src="${mvcPath}/main/workshop/alumni/js/carousel.js"></script>
    <script src="${mvcPath}/main/workshop/alumni/js/animate.js"></script>
    <script src="${mvcPath}/main/workshop/alumni/js/custom.js"></script>
    <!-- VIDEO BG PLUGINS -->
    <script src="${mvcPath}/main/workshop/alumni/js/videobg.js"></script>


    <script src="${mvcPath}/main/workshop/alumni/js/index.js"></script>
</body>
</html>